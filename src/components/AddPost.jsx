...
const AddPost = () => {
    const catogaries = ["Programming", "Designing", "Sports", "Fashion", "Development", "Economy", "Science", "Medical", "Politics", "Beauty", "Health", "Engineering", "Bussiness", "Entertaiment"];
    const { id } = useParams();
            ...
            <div className="row">
                <div className="col-lg-6 mx-auto">
                    <div className="sign-container p-lg-4 mt-5">
                        <h3 className='mb-4'><strong>Add blog</strong></h3>
                        <form onSubmit={handleSubmit} encType='multipart/form-data'>
                            ...
                            <div className="input-group mb-3">
                                <input type="text" placeholder='Sub title' name='subtitle' onChange={handleInput} />
                            </div>

                            <div className="input-group mb-3">
                                <select name="catogary" onChange={handleInput}>
                                    <option value="" disabled selected>Select Catogary</option>
                                    {
...

                            {
                                input.body.map((e, i) => {
                                    return <div className="input-group mb-3">
                                        <textarea placeholder='Body' name='body' onChange={(e) => handleBody(e, i)}></textarea>
                                    </div>
                                })
                            }
                            <button type='button' className='mb-3' onClick={addBody}>Add body</button>
